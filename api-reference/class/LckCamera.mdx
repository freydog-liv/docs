...
[`LckCamera`](/api-reference/class/LckCamera) is a component that integrates a standard Camera into the LIV Capture Kit (LCK) system.\
...
- Add an [`LckCamera`](/api-reference/class/LckCamera) component to a GameObject with a Unity Camera.
