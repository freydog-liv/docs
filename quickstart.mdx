---
title: "Quickstart"
description: "Go from zero to recording & streaming ready in just three steps."
---
...
<CardGroup cols={2}>
  <Card title="Spawn The Camera" icon="pen-to-square" href="/customisation/tablet-spawning">
    Best practices for integrating the camera into your game.
  </Card>
  <Card title="Tablet Customisation" icon="palette" href="/customisation/tablet-customisation">
    Learn about the components and features of the LCK Tablet.
  </Card>
  <Card title="Add Custom Audio" icon="square-code" href="/customisation/audio">
