---
title: "Quickstart"
description: "Go from zero to game ready in just a few steps."
---

## Add LCK in three easy steps

Configure your project and add LCK to your game.
...
<AccordionGroup>
  ...
  <Accordion title="Configure Input" icon="joystick">
    ...
    - Ensure your hand colliders have the tag `Hand` (or whatever tag you specified in `Project Settings/LCK/Trigger Enter Tag` by default this is `Hand`)
