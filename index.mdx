---
title: "Welcome"
description: "The LIV Creator Kit (LCK) is a flexible, modular, and lightweight SDK that allows users to record themselves directly within your Unity VR game or app. It includes a plug-and-play camera prefab that can be easily dragged and dropped into any compatible project for immediate recording. Alternatively, you can use the fully featured scripting API to create custom camera prefabs or systems."
---
