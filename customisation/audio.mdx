...
flowchart TD
    ...
    F -->|No| J[[No audio source found]]
        ...
        %% Styling
    style A fill:#DDEEFF,stroke:#4477AA,stroke-width:2px
    style D fill:#C8FACC,stroke:#228B22,stroke-width:2px
    style E fill:#FFFACD,stroke:#FFD700,stroke-width:2px
    style H fill:#C8FACC,stroke:#228B22,stroke-width:2px
    style I fill:#FFFACD,stroke:#FFD700,stroke-width:2px
    style J fill:#FECACA,stroke:#B22222,stroke-width:2px
```
