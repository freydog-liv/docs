...
Under the LCK License Agreement, you must display the LIV logo or an approved alternative from the SDK. You can see an example of logo placement on the default LCK tablet prefabs.
