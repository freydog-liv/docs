...
description: "Learn how to customise your tablet prefab."
---

## Tablet Mesh

We encourage developers to customize the tablet’s look and feel so it blends seamlessly with the style and atmosphere of their game. When creating new meshes, think about practical considerations such as different use cases, accessibility, and how easily the design can adapt to future features that may be added to the LCK tablet.

<Tip>
  We do recommend keeping changes minimal as we make enhancements and introduce new features may change the overall design. Should you choose to make completely new meshes, be aware that upgrading may be more effort.
</Tip>
...
Under the [LCK License Agreement](https://www.liv.tv/legal/sdk-license-agreement), you must display the LIV logo or an approved alternative from the SDK. You can see an example of logo placement on the default LCK tablet prefabs.

You can find these logo plates in the package under `/tv.liv.lck/Runtime/Prefabs/LIV Logo` and can use these in your custom tablet meshes.
