---
title: "LCK Tablet"
description: "Breakdown of tablet interface and functionality."
---
...
<AccordionGroup>
  <Accordion title="Mute Microphone/Audio Level" defaultOpen icon="microphone">
    Displays audio levels from user microphone, press to mute microphone.
  </Accordion>
  <Accordion title="Flip Aspect Ratio" defaultOpen icon="rotate">
    Press to flip aspect ratio between landscape/portrait when not recording.
  </Accordion>
  <Accordion title="Record" defaultOpen icon="record-vinyl">
    Stop and start recording, shows recording duration.
  </Accordion>
</AccordionGroup>