...
Upgrading version should for the most part only require you to delete the `tv.liv.lck` and `tv.liv.lck-streaming` folder already present in `Packages` and put in the newly downloaded versions, however there are some things to note:
