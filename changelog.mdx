...
<Update label="v1.3.5" tags={Patch} description="30th July 2025">
  **Added**
...
<Update label="v1.3.4" tags={Patch} description="16th July 2025">
  **Added**
...
<Update label="v1.3.3" tags={Patch} description="12th June 2025">
  **Added**
...
<Update label="v1.3.2" tags={Patch} description="5th June 2025">
  **Added**
...
<Update label="v1.3.1" tags={Patch} description="25th April 2025">
  **Fixed**

  - New quality option button missing collider on the Direct Tablet variant
</Update>

<Update label="v1.3.0" tags={Minor Update} description="23rd April 2025">
  **Added**
...
<Update label="v1.2.4" tags={Patch} description="3rd April 2025">
  **Added**
...
<Update label="v1.2.3" tags={Patch} description="12th March 2025">
  **Fixed**

  - EGL context creation issue causing recordings to fail with ERROR when using OpenGL
</Update>

<Update label="v1.2.2" tags={Patch} description="3rd March 2025">
  **Fixed**
...
<Update label="v1.2.1" tags={Patch} description="27th February 2025">
  **Changed**
...
<Update label="v1.2.0" tags={Minor Update} description="12th February 2025">
  **Added**
...
<Update label="v1.1.6" tags={Patch} description="10th January 2025">
  **Added**
...
<Update label="v1.1.5" tags={Patch} description="18th November 2024">
  **Fixed**
...
<Update label="v1.1.4" tags={Patch} description="12th November 2024">
  **Added**
...
<Update label="v1.1.3" tags={Patch} description="8th November 2024">
  **Fixed**
...
<Update label="v1.1.2" tags={Patch} description="5th November 2024">
  **Added**
...
<Update label="v1.1.1" tags={Patch} description="1st November 2024">
  **Fixed**

  - UnityNativeGallery conflict
</Update>

<Update label="v1.1.0" tags={Minor Update} description="30th October 2024">
  **Added**
...
<Update label="v1.0.0" tags={Major Update} description="Initial Launch">
  Initial release
</Update>