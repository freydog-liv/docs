...
<Update label="v1.4.3" description="18th December 2025">
  **Added**
...
<Update label="v1.4.2" description="17th November 2025">
  **Fixed**

  - Code stripping of LckService when Managed Stripping Level is set to High.
</Update>

<Update label="v1.4.1" description="13th November 2025">
  **Fixed**

  - Unwanted code stripping of default constructors when IL2CPP is enabled.
  - Wwise support for latest version.
</Update>

<Update label="v1.4.0" description="12th November 2025">
  **Added**
...
<Update label="v1.3.5" description="30th July 2025">
  **Added**
...
<Update label="v1.3.4" description="16th July 2025">
  **Added**
...
<Update label="v1.3.3" description="12th June 2025">
  **Added**
...
<Update label="v1.3.2" description="5th June 2025">
  **Added**
...
<Update label="v1.3.1" description="25th April 2025">
  **Fixed**

  - New quality option button missing collider on the Direct Tablet variant
</Update>

<Update label="v1.3.0" description="23rd April 2025">
  **Added**
...
<Update label="v1.2.4" description="3rd April 2025">
  **Added**
...
<Update label="v1.2.3" description="12th March 2025">
  **Fixed**

  - EGL context creation issue causing recordings to fail with ERROR when using OpenGL
</Update>

<Update label="v1.2.2" description="3rd March 2025">
  **Fixed**
...
<Update label="v1.2.1" description="27th February 2025">
  **Changed**
...
<Update label="v1.2.0" description="12th February 2025">
  **Added**
...
<Update label="v1.1.6" description="10th January 2025">
  **Added**
...
<Update label="v1.1.5" description="18th November 2024">
  **Fixed**
...
<Update label="v1.1.4" description="12th November 2024">
  **Added**
...
<Update label="v1.1.3" description="8th November 2024">
  **Fixed**
...
<Update label="v1.1.2" description="5th November 2024">
  **Added**
...
<Update label="v1.1.1" description="1st November 2024">
  **Fixed**

  - UnityNativeGallery conflict
</Update>

<Update label="v1.1.0" description="30th October 2024">
  **Added**
